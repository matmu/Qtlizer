...
changed from the standard value "r2" to "dprime". These are the only two possible methods. The linkage disequilibrium (parameter is called corr) can be set between 0.1 and 1. 
```{r}
